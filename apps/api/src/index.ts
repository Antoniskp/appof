...
app.get("/me", async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  return reply.send({
    ...
    providers: user.oauthAccounts.map(
...
const oauth2Config = oauth2 as typeof oauth2 & {
  GOOGLE_CONFIGURATION: unknown;
  GITHUB_CONFIGURATION: unknown;
  FACEBOOK_CONFIGURATION: unknown;
};
...
if (googleClientId && googleClientSecret) {
  app.register(oauth2, {
    ...
    credentials: {
      ...
      auth: oauth2Config.GOOGLE_CONFIGURATION,
    },
...
if (githubClientId && githubClientSecret) {
  app.register(oauth2, {
    ...
    credentials: {
      ...
      auth: oauth2Config.GITHUB_CONFIGURATION,
    },
...
if (facebookClientId && facebookClientSecret) {
  app.register(oauth2, {
    ...
    credentials: {
      ...
      auth: oauth2Config.FACEBOOK_CONFIGURATION,
    },
...
async function handleOAuth(
  ...
  let oauthClient: OAuth2Namespace | undefined;
